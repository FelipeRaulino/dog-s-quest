...
public class SlimeMazeIA2 : MonoBehaviour
{
    ...
    void ChangeState(enemyState newState){
        ...
        switch(newState){
            ...
            case enemyState.PATROL:
                ...
                agent.stoppingDistance = _GameManager.slimeStopDistance;
                idWayPoint = Random.Range(0, _GameManager.slimeWayPoints2.Length);
                destination = _GameManager.slimeWayPoints2[idWayPoint].position;
                agent.destination = destination;
